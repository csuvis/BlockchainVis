...
describe('#start', function() {
  describe('#checkConfigVersion2', function() {
    ...
    it('will give true with "datadir" at root', function() {
      ...
      var v2 = checkConfigVersion2({datadir: '/home/user/.silubiumcore/data', services: []});
  ...
  describe('#setupServices', function() {
    ...
    it('will require a local module with "silubiumcoreNode" in package.json', function() {
      function LocalService() {}
      LocalService.dependencies = [];
      LocalService.prototype.start = sinon.stub();
      LocalService.prototype.stop = sinon.stub();
      ...
      var testRequire = function(p) {
        if (p === notfoundPath) {
          ...
          return {
            name: 'local',
            silubiumcoreNode: 'lib/silubiumcoreNode.js'
          };
        } else if (p === 'local/lib/silubiumcoreNode.js') {
          return LocalService;
        }
      };
      var config = {
