...
/**
 * @returns {Boolean} - is proof-of-stake
 */
BlockHeader.prototype.isProofOfStake = function isProofOfStake() {
  return !/^0*$/.test(this.prevOutStakeHash.toString('hex')) && this.prevOutStakeN !== 0xffffffff;
};
