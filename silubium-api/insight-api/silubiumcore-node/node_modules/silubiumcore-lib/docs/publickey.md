# Public Key
Represents a SILUBIUM public key and is needed to be able to receive SILUBIUM, as is usually represented as a SILUBIUM [Address](address.md).

A PublicKey in silubiumcore is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
> var compressedPK2 = new silubiumcore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = silubiumcore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
