...
/**
 * Will return the path and silubiumcore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'silubiumcore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'silubiumcore-node.json'))
  };
}
