...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `silubiumcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ silubiumcore-node add wallet-service');
      console.log('    $ silubiumcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ silubiumcore-node remove wallet-service');
      console.log('    $ silubiumcore-node remove insight-api');
      console.log();
    });
